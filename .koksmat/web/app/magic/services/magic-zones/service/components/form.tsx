...
import {ServiceSchema} from "../applogic/model";
...
export function ServiceForm(props : {service: ServiceItem,editmode:"create"|"update"}) {
...
/>
 ...
 render={({ field }) => (
   <FormItem>
     <FormLabel>unique_service_id</FormLabel>
     <FormControl>
       <Input placeholder="" {...field} />
